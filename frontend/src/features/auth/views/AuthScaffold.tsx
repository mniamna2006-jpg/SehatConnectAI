...
const styles = StyleSheet.create({
  ...
  orbOne: { position: 'absolute', width: 126, height: 126, borderRadius: 63, backgroundColor: '#2563EB12', right: -34, top: -32 },
  orbTwo: { position: 'absolute', width: 70, height: 70, borderRadius: 35, backgroundColor: '#14B8A618', right: 42, bottom: -30 },
